...
return (
  <div className="w-[20%] h-full border-r-2 border-zinc-400 p-8">
    ...
    <nav className="flex flex-col text-zinc-400 text-l gap-1">
      ...
      <Link to="/tv_shows" className="hover:bg-[#DBF227] hover:text-[#042940] rounded-lg duration-300 p-4">
        <i className="mr-2 ri-tv-2-fill"></i>Tv Shows
      </Link>
      <Link to="/people" className="hover:bg-[#DBF227] hover:text-[#042940] rounded-lg duration-300 p-4">
